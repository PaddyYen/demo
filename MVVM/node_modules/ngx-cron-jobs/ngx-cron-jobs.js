...
class CronJobsComponent {
    ...
    ngOnInit() {
        this.baseFrequency$ = this.cronJobsForm.get('baseFrequency')
            .valueChanges.pipe(takeUntil(this.unSubscribe), map(v => +v), publishReplay(1), refCount());
        this.cronJobsForm
            .valueChanges.pipe(takeUntil(this.unSubscribe), filter(() => !this.isPatching), map((freq) => {
